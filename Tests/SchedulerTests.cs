...
namespace Tests
{
    ...
    public class SchedulerTests
    {
        ...
        [Test]
        public void Scheduler_ToString_On_Empty()
        {
            Scheduler<int> scheduler = new Scheduler<int>();
        ...
        [Test]
        public void Scheduler_Throws_AllQueuesEmptyException_On_Dequeue_On_Empty_List()
        {
            Scheduler<int> scheduler = new Scheduler<int>();

            Assert.AreEqual("{High:[],Medium:[],Low:[]}", scheduler.ToString());
            Assert.Throws(typeof(AllQueuesEmptyException), () => scheduler.Dequeue());
        }
    }
}
